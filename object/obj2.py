...
ap.add_argument("-p","--prototxt",required=True,help="prototxt file")
ap.add_argument("-m","--model",required=True,help="Caffemodel")
ap.add_argument("-c","--confidence",type=float,default=0.2, help="confidence level")
